...
_PASSOS_OAUTH = [
    ...
    },
    {
        ...
        "corpo": (
            ...
            "Você verá um formulário com 4 seções\n"
            "(Informações do app, Público, Dados de\n"
            "contato e Concluir). Em cada seção, clique\n"
            "em [bold]Avançar[/] após preencher:\n\n"
            "[bold cyan]1) Informações do app[/]\n"
            "   • Nome do app: qualquer\n"
            "     (ex: \"Contas Gastos\")\n"
            ...
            "   • Marque [bold]Externo[/]\n"
            "   → [bold]Avançar[/]\n\n"
            "[bold cyan]3) Dados de contato[/]\n"
            "   • Endereços de e-mail: seu e-mail\n"
            "   → [bold]Avançar[/]\n\n"
            "[bold cyan]4) Concluir[/]\n"
            "   • Aceite os termos (se aparecer)\n"
            "   → clique em [bold]Criar[/]\n\n"
            "[dim]Se a página rolar até \"Concluir\" sem mostrar\n"
            "as seções acima, role para cima — elas aparecem\n"
            "uma de cada vez conforme você avança.[/]"
        ),
    },
    {
